  ...
  return (
    <Page>
      <div className="h-full flex flex-col lg:flex-row lg:justify-center lg:items-center">
        <div className="min-h-[40vh] w-full lg:w-1/2 flex items-center justify-center lg:py-0">
          <div className="w-3/5 sm:w-1/2 md:w-1/3 lg:w-3/5 xl:w-1/2 pl-6">
            <ChassisCard card={card} />
          </div>
        </div>
        <div className="w-full lg:w-1/2 h-full flex flex-col justify-center gap-10 lg:overflow-auto p-4 md:p-10">
